...
│   ├── user_requirements.md      # 要求定義書 (URD)
│   ├── system_requirements.md    # 要件定義書 (SRD)
│   ├── high_level_design.md      # 基本設計書 (HLD)
│   ├── low_level_design.md       # 詳細設計書 (LLD)
│   └── document_ledger.md        # ドキュメント管理・台帳
├── src/                          # ソースコード
